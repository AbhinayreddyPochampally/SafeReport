...
import { ArrowLeft, Loader2, LogIn, Mail, Phone } from "lucide-react"
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-sm flex-col px-5 py-7">
      ...
      <div className="mt-8 flex flex-col items-center">
        {/* Designed APP icon — same brand mark used across the reporter
            flow. Larger size (56 px) for the centered hero treatment on
            this entry screen; matches the brand-bar 40 px icon used on
            every other surface. */}
        <AppIcon
          size={56}
          className="rounded-[14px] shadow-[0_4px_14px_rgba(10,31,70,0.22)]"
          aria-hidden
        />
